...
class Playground {
    ...
    selectHandler(e) {
        ...
        const isLineAlreadyTaken = (_b = (_a = this.store[selectedType]) === null || _a === void 0 ? void 0 : _a[mainAxisIndex]) === null || _b === void 0 ? void 0 : _b.find(el => el.index === Number(crossAxisIndex));
        if (isLineAlreadyTaken)
            this.selectedTakenLineHandler(isLineAlreadyTaken.owner);
        else {
            const newLine = {
                index: +crossAxisIndex,
                owner: this.match.turn
            };
            this.store[selectedType] = Object.assign(Object.assign({}, this.store[selectedType]), { [mainAxisIndex]: [...(((_c = this.store[selectedType]) === null || _c === void 0 ? void 0 : _c[mainAxisIndex]) || []), newLine] });
    ...
    checkForCompletedAreaSpace() {
        ...
        for (let key in this.store.row) {
            ...
            currentRow.forEach(row => {
                var _a, _b, _c;
                const haveYNextNeighborhood = (_a = this.store.row[(+key + 1)]) === null || _a === void 0 ? void 0 : _a.find(el => el.index === row.index);
                const haveXNextNeighborhood = (_b = this.store.column[key]) === null || _b === void 0 ? void 0 : _b.find(el => el.index === (row.index + 1));
                const baseXCol = (_c = this.store.column[key]) === null || _c === void 0 ? void 0 : _c.find(el => el.index === row.index);
